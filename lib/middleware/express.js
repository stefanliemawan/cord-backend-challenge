...
function checkPropertiesKeys(res, rulesProperties, obj) {
  if (rulesProperties.length == 1) {
...
export const checkAgainstRules = (req, res, next) => {
  ...
  switch (route) {
    ...
    case "/api/account/search":
      ...
      checkPropertiesKeys(res, parameters, query);
